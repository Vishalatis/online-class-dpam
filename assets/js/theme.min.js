...
function _objectWithoutPropertiesLoose(e, t) {
  if (null == e) return {};
  for (var o, n = {}, r = Object.keys(e), i = 0; i < r.length; i++)
    (o = r[i]), 0 <= t.indexOf(o) || (n[o] = e[o]);
  return n;
}
...
var docReady = function (e) {
  ...
  getColor = function (e) {
    ...
    return getComputedStyle(t).getPropertyValue("--sparrow-".concat(e)).trim();
  },
  ...
  getSoftColors = function (e) {
    return {
      primary: getColor("soft-primary", e),
      secondary: getColor("soft-secondary", e),
      success: getColor("soft-success", e),
      info: getColor("soft-info", e),
      warning: getColor("soft-warning", e),
      danger: getColor("soft-danger", e),
      light: getColor("soft-light", e),
      dark: getColor("soft-dark", e),
    };
  },
  getGrays = function (e) {
    return {
  ...
  getCurrentScreenBreakpoint = function () {
    var e = "";
    return {
      currentBreakpoint: (e =
        window.innerWidth >= breakpoints.xl
          ...
          ? "md"
          : "sm"),
      breakpointStartVal: breakpoints[e],
    };
  },
  ...
  getDates = function (o, e) {
    ...
    return Array.from({ length: 1 + (e - o) / n }, function (e, t) {
      return new Date(o.valueOf() + n * t);
    });
  },
  ...
  carouselInit = function () {
    var e = document.getElementById("hero-carousel"),
      t = document.getElementById("heroSlidercounter");
  ...
  countupInit = function () {
    window.countUp &&
      document.querySelectorAll("[data-countup]").forEach(function (e) {
        var t = utils.getData(e, "countup"),
          o = t.endValue,
          t = _objectWithoutProperties(t, _excluded),
          t = new window.countUp.CountUp(
            e,
            o,
            _objectSpread({ duration: 5 }, t)
          );
        t.error ? console.error(t.error) : t.start();
      });
  },
  heroHeaderInit = function () {
    var e = document.getElementById("topNav"),
      t = document.getElementById("hero-carousel"),
      o = document.getElementById("heroCarouselContainer"),
      n = document.getElementById("heroSlidercounterContainer");
    window.addEventListener("resize", function () {
      960 < window.innerWidth &&
        ((o.style.paddingLeft = getComputedStyle(e).marginLeft),
        (n.style.height = getComputedStyle(t).height));
    }),
      setTimeout(function () {
  ...
  swiperInit = function () {
    document.querySelectorAll("[data-swiper]").forEach(function (e) {
      var t,
        o,
        n = utils.getData(e, "swiper"),
        r = n.thumb;
      return (
        r &&
          ...
          (o.innerHTML = "<div class='swiper-wrapper'>".concat(t, "</div>")),
          (r.parent
            ? document.querySelector(r.parent)
            : e
          ).parentNode.appendChild(o),
          (o = new window.Swiper(o, r))),
        new window.Swiper(
          e,
          _objectSpread(
            _objectSpread({}, n),
